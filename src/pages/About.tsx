            ...
            <CardContent className="p-8">
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-20 font-orbitron font-bold text-primary">2023</div>
                  <div>
                    <h3 className="font-orbitron font-semibold text-lg mb-2">Club Foundation</h3>
                    <p className="text-muted-foreground">
                      The NIT Silchar Esports Club was officially established with 50 founding members passionate
                      about competitive gaming.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-20 font-orbitron font-bold text-secondary">2024</div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-20 font-orbitron font-bold text-accent">2025</div>
                  <div>
                    <h3 className="font-orbitron font-semibold text-lg mb-2">National Recognition</h3>
                    <p className="text-muted-foreground">
                      Our teams competed in national-level tournaments, bringing home multiple championships and
                      putting NIT Silchar on the esports map.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">esports@nits.ac.in</p>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">@nitsilchar_esports</p>
                </div>
              </div>
            </CardContent>
          </Card>
